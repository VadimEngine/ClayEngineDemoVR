...
void InputHandler::initialize(XrInstance theXrInstance, XrSession theSession, XrSpace localSpace, XrSpace headSpace) {
...
void InputHandler::createActionSet() {
    ...
    createAction(
        mXRInstance_,
        mButtonActions_[static_cast<int>(InputHandler::Button::Y)],
        "y-button",
        XR_ACTION_TYPE_BOOLEAN_INPUT
    );
    createAction(
        mXRInstance_,
        mButtonActions_[static_cast<int>(InputHandler::Button::X)],
        "x-button",
        XR_ACTION_TYPE_BOOLEAN_INPUT
    );
    createAction(
        mXRInstance_,
        mButtonActions_[static_cast<int>(InputHandler::Button::B)],
        "b-button",
        XR_ACTION_TYPE_BOOLEAN_INPUT
    );
    createAction(
        mXRInstance_,
        mButtonActions_[static_cast<int>(InputHandler::Button::A)],
        "a-button",
        XR_ACTION_TYPE_BOOLEAN_INPUT
    );
...
void InputHandler::suggestBindings() {
    ...
    any_ok |= suggestBindings(
            ...
            "/interaction_profiles/oculus/touch_controller",
            {
                    ...
                    {mButtonActions_[static_cast<int>(InputHandler::Button::Y)], createXrPath("/user/hand/left/input/y/click", mXRInstance_)},
                    {mButtonActions_[static_cast<int>(InputHandler::Button::X)], createXrPath("/user/hand/left/input/x/click", mXRInstance_)},
                    {mButtonActions_[static_cast<int>(InputHandler::Button::B)], createXrPath("/user/hand/right/input/b/click", mXRInstance_)},
                    {mButtonActions_[static_cast<int>(InputHandler::Button::A)], createXrPath("/user/hand/right/input/a/click", mXRInstance_)},
...
void InputHandler::recordCurrentBindings() {
    if (mSession_) {
        // now we are ready to:
...
void InputHandler::createActionPoses() {
...
void InputHandler::attachActionSet() {
...
void InputHandler::pollActions(XrTime predictedTime) {
    ...
    // button states
    for (int i = 0; i < static_cast<int>(InputHandler::Button::LAST); ++i) {
...
const XrPosef& InputHandler::getAimPose(InputHandler::Hand hand) const {
    return mAimPose_[static_cast<int>(hand)];
}

const XrPosef& InputHandler::getGripPose(InputHandler::Hand hand) const {
    return mGripPose_[static_cast<int>(hand)];
}

const XrPosef& InputHandler::getHeadPose() const {
    return mHeadPose_;
}

const XrVector2f& InputHandler::getJoystickDirection(Hand hand) const {
    return mJoystickDirState_[static_cast<int>(hand)].currentState;
}

bool InputHandler::getButtonDown(InputHandler::Button button) const {
    return mButtonStates_[static_cast<int>(button)].currentState;
}

float InputHandler::getTriggerState(InputHandler::Hand hand) const {
    return mTriggerState_[static_cast<int>(hand)].currentState;
}

float InputHandler::getGrabState(InputHandler::Hand hand) const {
